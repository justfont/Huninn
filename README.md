...
- **Version 1.000**: May 17, 2024
  - Fork from jf-open-huninn repository ([justfont/open-huninn-font](https://github.com/justfont/open-huninn-font)), modify the OFL License, and rename it to *Justfont Huninn* for Google Fonts onboarding.
